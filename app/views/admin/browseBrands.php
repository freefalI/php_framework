...
<body>
    ...
    <div id ="wrapper" >
    <br>
    <h1 id="table-header">Brands</h1>    
    <br>
        <a href="/add/brands"><button class="btn btn-info" id="go-to-add-page-button">Add new</button></a>
        <br> <br>
    <div class="table-responsive">
            <table class="table table-striped">
              ...
              @foreach ($brands as $brand):
                <tr>
                <td><a href="/edit/brands/{{$brand->id}}"><i class="fas fa-pencil-alt"></i></a></td>
                  <td>{{$brand->id}}</td>
                  <td>{{$brand->name}}</td>
                  <td><a href="/delete/brands/{{$brand->id}}" onclick="return confirm('Запись будет удалена из бд. Удалить запись?')"><i class="fas fa-times"></i></a></td>
                </tr>
                @endforeach;
              </tbody>
            </table>
